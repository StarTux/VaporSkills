...
public enum Perk {
    ...
    RANCH_COW(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_MUSHROOM_COW(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_PIG(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_SHEEP(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_CHICKEN(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_RABBIT(SkillType.RANCH, Perk.RANCH_CARRY),
    // Ranching Utility
    RANCH_TWINS(SkillType.RANCH, Perk.RANCH_CARRY),
    RANCH_TRIPLETS(SkillType.RANCH, Perk.RANCH_TWINS),
    RANCH_INSPECT_BOOK(SkillType.RANCH, Perk.RANCH_TWINS),
