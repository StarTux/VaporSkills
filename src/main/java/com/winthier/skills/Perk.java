...
public enum Perk {
    ...
    RANCH_INSPECT_QUIRK(SkillType.RANCH, Perk.RANCH_INSPECT_BOOK),
    RANCH_INSPECT_TREAT(SkillType.RANCH, Perk.RANCH_INSPECT_QUIRK),
    RANCH_INSPECT_TOY(SkillType.RANCH, Perk.RANCH_INSPECT_TREAT),
    // Ranching Specific
