...
public enum Perk {
    ...
    SMITH_DIAMOND_ARMOR_ARMOR(SkillType.SMITH, Perk.SMITH_DIAMOND),
    SMITH_DIAMOND_ARMOR_TOUGH(SkillType.SMITH, Perk.SMITH_DIAMOND_ARMOR_ARMOR),
    SMITH_SHIELD_ARMOR(SkillType.SMITH, Perk.SMITH_IRON),
    SMITH_SHIELD_KNOCKBACK_RESIST(SkillType.SMITH, Perk.SMITH_SHIELD_ARMOR),
    SMITH_SWORD_DAMAGE(SkillType.SMITH, Perk.SMITH_IRON),
    SMITH_AXE_DAMAGE(SkillType.SMITH, Perk.SMITH_IRON),
    // Brawl Swords
